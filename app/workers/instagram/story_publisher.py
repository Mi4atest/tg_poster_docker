...
INSTAGRAM_STORY_MODE = os.getenv("INSTAGRAM_STORY_MODE", "disabled").lower()
...
async def publish_story_to_instagram(story_id: str) -> bool:
    """Публикация истории в Instagram."""
    if INSTAGRAM_STORY_MODE != "instagrapi":
        logger.warning(
            "Публикация сторис в Instagram отключена. "
            "Установите INSTAGRAM_STORY_MODE=instagrapi для legacy-режима."
        )
        return False
